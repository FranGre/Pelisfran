<%@ Page Title="" Language="C#" MasterPageFile="~/PaginasMaestras/Base.Master" AutoEventWireup="true" CodeBehind="editar.aspx.cs" Inherits="Pelisfran.admin.generos.editar" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h2 id="titulo" runat="server" class="title is-2 mb-6 is-flex is-justify-content-center">Editar Genero</h2>
    ...
    <asp:Button ID="btnAceptar" runat="server" Text="Guardar" OnClick="btnAceptar_Click" CssClass="button is-primary" />
</asp:Content>
